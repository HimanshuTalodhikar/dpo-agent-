  ...
  return (
    <header className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 p-4 md:px-8 mb-6 glass-panel rounded-2xl border-amber-500/30">
      ...
      <div
        ...
        title="Return to DPO Agent Main Overview"
      >
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl md:text-2xl font-extrabold tracking-tight text-white font-robot uppercase group-hover:text-amber-300 transition-colors">
              DPO <span className="text-amber-400">AGENT</span>
            </h1>
      ...
      {/* Codemax AI Badge (Profile removed as requested) */}
      <div className="flex items-center gap-3">
        <div className="px-4 py-2 text-xs font-robot font-bold rounded-full bg-amber-400 text-black flex items-center gap-2 shadow-glow-gold">
          <Sparkles className="w-4 h-4" />
          <span>Codemax AI Engine</span>
        </div>
      </div>
    </header>
  );
